...
<html lang="en">
    <head>
        ...
        <title><?php echo currencyName($currency); ?> Node Monitor - <?php echo e($nanoNodeName); ?></title>
        ...
        <meta property="og:title" content="<?php echo currencyName($currency); ?> Node Monitor - <?php echo e($nanoNodeName); ?>">
        ...
        <meta name="nano" content="<?php echo e($nanoDonationAccount); ?>">
    </head>
    <body>
    <script>
    var init = [];
    var GLOBAL_REFRESH = <?php echo (int) $autoRefreshInSeconds; ?>;
    var GLOBAL_DIGITS = <?php echo (int) $nanoNumDecimalPlaces; ?>;
    </script>
